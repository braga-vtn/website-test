      ...
      <Container className="flex flex-col items-center justify-between pb-20">
        ...
        <div className="max-w-7xl mx-auto antialiased pt-4 relative">
          <p className="mt-2 font-normal text-base text-current dark:text-neutral-300 text-center">
            ...
            <br /><br />
            Para postar algum item em nosso Marketplace, você precisa ser um <a href="/products/creator" className="font-semibold hover:underline">Criador de Conteúdo</a>. A intermediação dos pagamentos é realizada exclusivamente pela Vistune, garantindo a segurança tanto para o usuário quanto para o &quot;Criador de Conteúdo&quot;. Nosso objetivo com o Marketplace é controlar o mercado paralelo que surge com a Vistune de maneira respeitosa e organizada, permitindo que possamos evoluir juntos.
          </p>
        </div>
