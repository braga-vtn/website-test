    ...
    <Container className="mt-16 lg:mt-32">
      <div className="flex justify-between items-center px-2 py-8">
        <Link href="/blog" className="flex space-x-2 items-center">
          <IconArrowLeft className="w-4 h-4 text-current dark:text-muted-dark" />
          <span className="text-sm text-current dark:text-muted-dark">Voltar</span>
        </Link>
        <div className="flex space-x-2 items-center">
          <div className="flex space-x-2 items-center ">
            ...
            />
            <p className="text-sm font-normal text-current dark:text-muted-dark">
              {blog.author.name}
            </p>
          </div>
          ...
          <time dateTime={blog.date} className="flex items-center text-base ">
            <span className="text-current dark:text-muted-dark text-sm">
              {format(new Date(blog.date), "MMMM dd, yyyy", { locale: ptBR })}
            </span>
          </time>
        </div>
      </div>
      ...
      <div className="xl:relative">
        <div className="mx-auto max-w-2xl">
          <article className="pb-8">
            ...
            <div
              className="mt-8 prose prose-sm dark:prose-invert mx-auto"
              data-mdx-content
            >
              {children}
            </div>
