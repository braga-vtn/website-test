...
export const CreatorContent = () => {
  return (
    <div className="flex flex-col min-h-screen pt-16 md:pt-48 relative overflow-hidden">
      ...
      >
        <Balancer>Seja um Criador de Conteúdo</Balancer>
      </motion.h1>
      <motion.p
        initial={{
          y: 40,
      ...
      >
        <Balancer>
          Um Criador pode criar canais e comunidades na Vistune University, além de oferecer produtos e serviços em nosso Marketplace.
        </Balancer>
      </motion.p>
