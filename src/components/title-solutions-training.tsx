...
export const SolutionTraining = () => {
  return (
    <div className="flex flex-col min-h-screen pt-8 md:pt-24 relative overflow-hidden">
      ...
      >
        <Balancer>Treine os Modelos e Agentes de IA</Balancer>
      </motion.h1>
      <motion.p
        initial={{
          y: 40,
      ...
      >
        <Balancer>
          Alimente suas criações com arquivos, sites e texto, para utilizar a Inteligência Artificial à sua necessidade com precisão.
        </Balancer>
      </motion.p>
