      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 text-white text-xl bg-neutral-900/50 backdrop-blur-md rounded-full p-2 dark:bg-neutral-100/50 dark:text-black">
