  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        Um Aplicativo <br /> Para Seu Negócio!
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Todas as funcionalidades estão à sua disposição sob a marca do seu negócio, sem a necessidade de se preocupar com desenvolvimento e manutenção. Sua missão será focar em vender e oferecer suporte aos seus clientes!
      </p>
    </div>
  );
};
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 font-semibold left-4 opacity-0 group-hover/product:opacity-100 text-white">
        {product.title}
      </h2>
    </motion.div>
  );
