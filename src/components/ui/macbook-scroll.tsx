...
import SvgVistune from "../svg/svg-vistune";
import { VideoApplication } from "../video-application";
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[150vh] flex flex-col items-center py-0 md:pt-32 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
