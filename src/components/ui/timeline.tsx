...
export const Timeline = ({ data, notitle }: { data: TimelineEntry[], notitle?: boolean }) => {
  ...
  return (
    <div
      className="w-full bg-transparent md:px-10 mb-20"
      ref={containerRef}
    >
      {!notitle &&
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-neutral-950 via-neutral-500 dark:from-neutral-50 dark:via-neutral-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
