...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  }, [globeConfig.globeColor, globeConfig.emissive, globeConfig.emissiveIntensity, globeConfig.shininess, globeRef]);
...
}, [globeData, data.length]); // Certifique-se de incluir data.length
...
export function WebGLRendererConfig() {
  ...
  }, [gl, size.width, size.height]); // Incluir dependências corretas
  return null;
}
