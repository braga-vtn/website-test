...
export const Button: React.FC<{
  ...
  className?: string;
  variant?: "simple" | "outline" | "primary" | "disable";
      ...
      variant === "simple"
        ...
        : variant === "outline"
          ...
          : variant === "primary"
            ...
            : variant === "disable"
              ? "bg-transparent cursor-default relative z-10 text-sm md:text-sm transition font-medium px-4 py-2 flex items-center justify-center"
              : "";
    return (
      <Tag
        className={cn(
          "bg-black relative z-10 text-white text-sm md:text-sm transition font-medium duration-200  rounded-full px-4 py-2  flex items-center justify-center",
          variantClass,
          className
        )}
        // style={{
